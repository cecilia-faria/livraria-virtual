...
function configurarBotoesAdicionarCarrinho() {
    document.querySelectorAll('.botao-carrinho').forEach((botao, index) => {
        botao.addEventListener('click', () => {
            ...
            // Verifica swe o produto já está no carrinho (usando índice como ID)
...
let quantidadeTotal = 0;
    ...
    //Percorre todos os items do carrinho
    ...
    // Reconfigura os botões + e - de quantidade
...
// Alterna a visibilidade de carrinho lateral
